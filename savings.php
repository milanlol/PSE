    ...
    <div class="container savings">
        <div class="row">
            <div class="col-md-10">
                ...
                <h4>Certificates </h4>
                <p>Members may choose from several types of certificates. Pick a term that meets your financial goals. Interest is paid monthly, or quarterly, based on the certificate chosen. </p>
                <p class="small-print">(Associated fees may reduce the earnings on this account.)</p>
                <p class="view-rate"><a href="rates.php">View Rates <i class="fa fa-hand-o-right"></i></a></p>
                <h4>Christmas Club</h4>
                <p>Start to save now for your holiday expenses. Your savings, plus interest, is deposited directly into your regular savings account on November 1 each year. The dividend rates are set by the Board of Directors in the month prior to payment, and are calculated by averaging the dividend rates that have been set for the past year. </p>
                <p class="small-print">(Associated fees may reduce the earnings on this account.)</p>
                <p class="view-rate"><a href="rates.php">View Rates <i class="fa fa-hand-o-right"></i></a></p>                    

                <h4>Individual Retirement Accounts (IRAs)</h4>
                <p>Plan for your future with an IRA. Members may choose a variable or fixed rate account. IRA certificates are available at higher rates. Payments to your IRA can be made via payroll deduction, regular deposits, or a lump sum contribution. </p>
                <p class="small-print">(Associated fees may reduce the earnings on this account.)</p>
                <p class="view-rate"><a href="rates.php">View Rates <i class="fa fa-hand-o-right"></i></a></p>                    

                <h4>Special Savings</h4>
                <p>Start to save for that new computer system you've had your eye on or that dream vacation you've been thinking about. You can open a special savings account and call it anything you want. You decide. To make saving even easier, you can have your money automatically deposited into your special savings account via payroll deduction or direct deposit. </p>
                <p class="small-print">(Associated fees may reduce the earnings on this account.)</p>
                <p class="view-rate"><a href="rates.php">View Rates <i class="fa fa-hand-o-right"></i></a></p>                    
            </div>
        </div>
